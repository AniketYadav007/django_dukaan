...
def all_products(request):
    ...
    return render(request,'shop/products.html',{
        'filter': f, 'brands':Brand.objects.filter(favorite=True), 'categories': Category.objects.all()
    })
...
def brand_products(request, brand):
    ...
    return render(request,'shop/brand_products.html',{
        'brand': brandObj, 'products': products, 'brands':Brand.objects.all(), 'categories': Category.objects.all()
    })
